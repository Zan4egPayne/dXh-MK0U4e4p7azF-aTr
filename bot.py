...
async def help( ctx, amount = 1 ):
    ...
    emb1.add_field( name = '``{}rolton``'.format( PREFIX ), value = 'Заварить ролтон.' )
    ...
    emb2.add_field( name = '``{}passgen``'.format( PREFIX ), value= 'Сгенерировать сложный пароль.' )
    emb2.add_field( name = '``{}getip``'.format( PREFIX ), value= 'Получить айпи по домену.' )
    emb2.add_field( name = '``{}invite``'.format( PREFIX ), value= 'Пригласить бота на свой сервер.' )
    ...
    emb3.add_field( name = '``{}ping``'.format( PREFIX ), value= 'Узнать задержку бота.' )
    ...
    emb4.add_field( name = '``{}randcolor``'.format( PREFIX ), value= 'Рандомный цвет' )
    emb4.add_field( name = '``{}achievement``'.format( PREFIX ), value= 'Сделать кастомную ачивку' )
    emb4.add_field( name = '``{}weather``'.format( PREFIX ), value= 'Получить погоду' )
